...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const inputDefaultStyle = `border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition-all ${
    ...
    return (
      <div className={containerFinalStyle}>
        <div className='flex items-center gap-x-1'>
          <label
            htmlFor={label}
            className='block mb-1 text-xs font-medium text-text-primary'
          >
            {label}
          </label>
        ...
        {type === 'password' ? (
          <div
            className={
              inputFinalStyle +
              'flex focus-within:border-2 focus-within:border-blue-700 py-2'
            }
          >
            <input
              id={label}
          ...
          <div
            className={
              ...
              `flex focus-within:border-2 focus-within:border-blue-700 bg-white ${
                readOnly || disabled
                  ? '!border-gray-100 !bg-gray-disabled'
